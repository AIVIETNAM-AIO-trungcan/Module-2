...
class CreditDataCleaner:
    ...
    def __init__(
        ...
        Args:
            ...
            cleaning_config (Dict[str, Any]): Dictionary containing min/max validation rules.
        """
    ...
    def transform(self, X: pd.DataFrame) -> pd.DataFrame:
        """
        Clean the dataset using dynamic boundaries.
...
class WOETransformer:
    ...
    def __init__(
        ...
        Args:
            ...
            bin_config (Dict[str, Any]): Settings for optbinning.
        ...
        self.small_bin_threshold = diagnostics_config.get("small_bin_threshold", 0.05)
        self.extreme_woe_threshold = diagnostics_config.get(
    ...
    def _prepare_feature_array(self, data: pd.DataFrame, feature: str) -> np.ndarray:
        """Prepare column dtype correctly for OptBinning solver."""
        if feature in self.categorical_features:
            return data[feature].astype(object).to_numpy()
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series) -> "WOETransformer":
        ...
        Args:
            ...
            y (pd.Series): Target labels (1 for Bad, 0 for Good).
        ...
        for feature in all_features:
            ...
            # Reconstruct woe_dictionaries for backward compatibility (used in main.py Step 7)
